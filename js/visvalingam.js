...
chars.simplify.algorithms.visvalingam = function (pointList) {
	...
	while (trianglesVec.length !== 0) {
        ...
        trianglesVec.sort(function (a, b) {
...
chars.simplify.algorithms.visvalingamTrianglesToKeep = function (pointList, toKeep) {
    var newPointListAll = this.visvalingam(pointList);
    var newPointList = [];
    var point;
    var i;
    for (i = 0; i < newPointListAll.length; i++) {
        point = newPointListAll[i];
        if (point.z < toKeep) {
...
chars.simplify.algorithms.visvalingamKeep = function (pointList, toKeep) {
    // Create a copy of the PointList[]
    var newPointList = chars.simplify.algorithms.helper.copy(pointList);
    var size = newPointList.length;
    ...
    var count = newPointList.length;
    var tri;


    while (trianglesVec.length !== 0 && count > toKeep) {
    ...
    var returnPointList = [];
    var point;
    for (i = 0; i < newPointList.length; i++) {
